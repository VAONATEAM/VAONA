...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./vaona.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S vaona -X kill
screen -S vaona ./vaona
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/vaonaTEAM/Files_vaona/master/File_Bot/commands.lua") 
...
local vaona_Msg = ''  
if msgs < 100 then 
vaona_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
vaona_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
vaona_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
vaona_Msg = 'متفاعل' 
elseif msgs < 1200 then 
vaona_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
vaona_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
vaona_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
vaona_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
vaona_Msg = 'قمة التفاعل' 
elseif msgs < 5500 then 
vaona_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
vaona_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
vaona_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
vaona_Msg = 'رب التفاعل'  
end 
return vaona_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function Sourcevaona(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,vaona_Msg) 
return false  
end 
if text then    
...
if text == 'معلومات السيرفر ⌯' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local vaona1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..vaona1.server.uptime_in_days..'('..vaona1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..vaona1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..vaona1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..vaona1.stats.instantaneous_ops_per_sec..'`\n'
send(msg.chat_id_, msg.id_, text2)  
end


if text == 'تحديث السورس ⌯' and SudoBot(msg) then 
os.execute('rm -rf vaona.lua')
os.execute('wget https://raw.githubusercontent.com/vaonaTEAM/vaona/master/vaona.lua')
...
send(msg.chat_id_, msg.id_,'⌯︙عدد المجموعات الان » { '..#group..' }'..vaonak..''..vaona..'\n*⌯︙الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')
end
end
end,nil)
end
...
usertext = '\n⌯︙العضو » ['..result.title_..'](t.me/'..(username or 'UUU0Q')..')'
status  = '\n⌯︙تم ترقيته مطور'
...
usertext = '\n⌯︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'UUU0Q')..')'
status  = '\n⌯︙تم ترقيته مطور'
...
local vaona1_Msg = database:get(bot_id.."vaona1:Add:Filter:Rp2"..text..msg.chat_id_)   
if vaona1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌯︙العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'UUU0Q')..') \n⌯︙'..vaona1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if vaona_Msg and not Special(msg) then  
local vaona_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if vaona_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⌯︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..vaona_Msg.."] \n")
else
send(msg.chat_id_,0,"⌯︙العضو : {["..data.first_name_.."](T.ME/UUU0Q)}\n⌯︙["..vaona_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⌯︙عذرا » {["..data.first_name_.."](T.ME/UUU0Q)}\n⌯︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,'⌯︙بالتأكيد تم تفعيل المجموعه')
else
...
send(msg.chat_id_, msg.id_,'⌯︙بالتأكيد تم تعطيل المجموعه')
else
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'⌯︙تم تفعيل المجموعه')
else
sendText(msg.chat_id_,'\n⌯︙بواسطه ← ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n⌯︙تم تفعيل المجموعه {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
⌯︙↬vaona TEAM
 … … … … … … … … … … …
⌯︙↬[Channel vaona](t.me/UUU0Q) 
… … … … … … … … … … …
⌯︙↬[Information](t.me/d6d6i)
… … … … … … … … … … …
⌯︙↬[DEVELOPER](t.me/VAONATEAM)
… … … … … … … … … … …
⌯︙↬[The way his inauguration](https://t.me/UUU0Q/365)
… … … … … … … … … … …
⌯︙↬[To talk to us](t.me/D6D6Ibot)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'⌯︙بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'UUU0Q')..') \n⌯︙تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌯︙بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'UUU0Q')..') \n⌯︙تـم قفـل التاك بالكتم ')
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/vaonaTEAM/Files_vaona/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⌯︙اهلا بك في متجر ملفات فيونا\n⌯︙ملفات السورس ↓\n… … … … … … … … … … …\n\n"
local TextE = "\n… … … … … … … … … … …\n⌯︙علامة تعني { ✓ } ملف مفعل\n⌯︙علامة تعني { ✘ } ملف معطل\n⌯︙قناة سورس فيونا ↓\n".."⌯︙[اضغط هنا لدخول](t.me/UUU0Q) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/vaonaTEAM/Files_vaona/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('vaona.lua')  
else
send(msg.chat_id_, msg.id_,"⌯︙عذرا الملف لايدعم سورس فيونا \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n⌯︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'UUU0Q')..')'
status  = '\n⌯︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n⌯︙العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, '⌯︙تم تنزيل جميع صخوله من المجموعه')
end
...
database:set(bot_id.."vaona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."vaona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"⌯︙ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."vaona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."vaona1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."vaona1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."vaona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"⌯︙تم منع الكلمه مع التحذير")  
database:del(bot_id.."vaona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."vaona1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."vaona1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."vaona1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"⌯︙ارسل الكلمه الان")  
database:set(bot_id.."vaona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."vaona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."vaona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."vaona1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."vaona1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."vaona1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."vaona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."vaona1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."vaona1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⌯︙قائمة المنع \n… … … … … … … … … … …\n"
for k,v in pairs(list) do  
local vaona_Msg = database:get(bot_id.."vaona1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..vaona_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⌯︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'UUU0Q')..')'..'\n⌯︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'فيونا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'فيونا')
local vaona_Msg = {
'اسمي مينو كول',
'دا اشرب جاي مفارغلك',
'لابسك لتلح',
...
send(msg.chat_id_, msg.id_,'['..vaona_Msg[math.random(#vaona_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فيونا').." غادر" or text == 'بوت غادر' then  
...
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '⌯︙اسم البوت ← '..(database:get(bot_id..'Name:Bot') or 'فيونا')..'\n'..'⌯︙عدد المجموعات ← {'..Groups..'}'..'\n⌯︙عدد المشتركين ← {'..Users..'}'
send(msg.chat_id_, msg.id_,Text) 
end
return false
end
...
-- vardump(data) 
vaonadx(msg.chat_id_, msg.id_, '⌯︙ايدي المجموعة » ( '..msg.chat_id_..' )\n⌯︙عدد الادمنيه » ( *'..data.administrator_count_..' )*\n⌯︙عدد المحظورين » ( *'..data.kicked_count_..' )*\n⌯︙عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فيونا')
...
vaona = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(vaona)
...
--------------------------------------------------------------------------------------------------------------
Sourcevaona(data.message_,data)
...
------------------------------------------------------------------------
local vaonaAbot = database:get(bot_id.."vaona1:Add:Filter:Rp2"..text..result.chat_id_)   
if vaonaAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⌯︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..vaonaAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local vaona1_Msg = database:get(bot_id.."vaona1:Add:Filter:Rp2"..text..result.chat_id_)   
if vaona1_Msg then    
send(msg.chat_id_, msg.id_,"⌯︙"..vaona1_Msg)
